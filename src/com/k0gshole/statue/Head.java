...
public class Head{
	...
	public static boolean generate(World par1World, Random par2Random, int par3,int par4, int par5, CommandSender sender, String skinName){
		...
		int[] [] pieces = new int[] []{ 
				{8, 15, 0, 7, XDIM, ZDIM, 0, 7, 1},//Head Top
				{16, 23, 0, 7, XDIM, ZDIM, 0, 0, 1},	// Head Bottom};	
				{0,  7,  8,  15,  -ZDIM,  YDIM,  0,  0,  2},	// Head Left
				{16,  23,  8,  15,  ZDIM,  YDIM,  7,  0,  1},	// Head Right
				{24,  31,  8,  15,  XDIM,  YDIM,  0,  0, 8},	// Head Back*/
				{15,  8,  8,  15,  -XDIM,  YDIM,  15,  0,  1}	// Head Front/*
		    	...
		    	{46,  43,  20,  30,  XDIM,  YDIM,  -4,  11,  2},	// Left Arm Front
		    	{43,  46,  20,  30,  -XDIM,  YDIM,  9,  11,  2},	// Right Arm Front*/
				/*};
