...
public class Pixel{
	...
	public Pixel(Mod_statue plugin) {
		this.plugin = plugin;
	}
	...
	public static boolean generate(World par1World, Random par2Random, int par3,int par4, int par5, CommandSender sender){


		File fileTemp = new File("./plugins/statue/64.png");
